...
\par
Úkoly byly přidělovány jednotlivým členům týmu. Samotn0 úkoly uchovával systém Redmine\cite{Redmine} a umožňoval sledovat jejich stav.
...
z příčin chování, na kterou reaguji v návrhu na spojení chyb analyzátoru \autoref{analyser-join}.
\par
...
Vzhledem ke změně rozhraní, které zachovává způsob nalezení adres, stačilo vytvořit ostatní části Managera, tak aby odpovídalo novému rozhraní.
\par
...
\begin{lstlisting}[language=Java, caption={Společná metoda zajišťující odeslání DataProvider požadavk.ů}]
    /**
...
Dále bylo nutné uložit detailní informace o chybách. Pro ty jsem vytvořil další tabulku, která je spojena vazbou 1:n s databázovou reprezentací chyby.
\par
...
a vytížení serveru. Data jsou odesílány přímo do služby DataDog. Externí webové rozhraní umožňuje zobrazení posbíraných údajů.
\par

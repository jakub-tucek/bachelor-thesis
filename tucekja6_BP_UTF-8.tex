...
\acknowledgements{Rád bych poděkoval za trpělivost vedoucímu, Ing. Jiřímu Hunkovi.}
...
menší obchody: \textit{k24} a \textit{elektrocr}. Příčina byla odlišná implementace hledání, kdy nestačilo pouze stáhnout
...
\par
V návaznosti na tyto nedostatky jsem navrhl rozsáhlé refaktorování a změnu architektury problémových tříd.
Před přidáním nové funkcionality bylo nutné opravit stávající procesy, které jsou neefektivní nebo 
...
Podporu hledání samotných obchodů je nahrazeno manuálním vložením přes webové rozhraní administrátorem.
\par
Refaktorování a změna návrhu tříd potvrdila, že se jedná o výhodný krok. Následné změny a úpravy bylo možné 
jednoduše přidat do nové architektury. Opravení stávajících procesů vylepšilo celkovou uživatelskou přívětivost pro
administrátora.
\par
Po implementování nově navrženého modulu a procesu párování jsem během testování objevil nové chyby, které
neumožňovaly kontinuální běh systému nebo značně zhoršovaly administrátorské rozhraní. Jednalo se především o zahlcení administrátora chybami 
a více možných struktur stránky detailu produktu na stejném obchodě. Chyby jsem v rámci implementace úspěšně opravil.
\par
Byly také objeveny nové nedostatky, které se odstranit nepodařilo. Zde se jedná například o velkou zátěž na administrátora při
párování produktů nebo nemožnost vyhledávat produkty na 2 specifických obchodech z 20 testovaných.
\par
Systém je po správném nastavení schopný dlouhodobě a automaticky sbírat určitý vzorek dat. Není však v aktuálním stavu vhodný
pro široké použití z důvodů nemožnosti vyhledávat samotné obchody a nefunkčnost na některých obchodech. 
Věřím však, že oprava hlavních nedostatků pro takové použití není velmi náročná a je tedy možné docílit takového stavu, který bude mít reálnou využitelnost.

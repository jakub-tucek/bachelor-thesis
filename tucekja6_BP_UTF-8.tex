...
Nejprve popíši cíl, který měl projekt za úkol řešit a jaké byly použité postupy při vývoji. Budu se také věnovat
základnímu návrhu aplikace, podle kterého byla následně implementována a hlavním použitým technologiím. V poslední části
zmíním mou roli v týmovém projektu.
...
existují. Výsledek je poté odeslán k zpracování a uložení do databáze Managerem.

...
Možnost jednoznačného určení elementů na stránce umožňuje vybrat pouze částí, které jsou v kontextu hledání zajímavé.
...
\begin{figure}[h]\centering
	...
	\caption[Diagram vytvoření kampaně a nalezení nových dat v původním řešení]

...
\begin{center}
    ...
    Kritické chyby & 2 & 
		V případě chybného odeslání není chyba šablony nebo analyzátoru znova zpracována \\ \hline
	& &	V případě chybného odeslání není chyba šablony nebo analyzátoru znova zpracována \\ \hline
	\hline
    Úplnost funkcionality& 3 & 
		Systém nevyhledává internetové obchody \\ \hline
	& &	Systém nevyhledává adresy detailů produktů \\ \hline
	& &	Systém neplánuje práci v požadovaných intervalech \\ \hline
	& &	Neexistence procesu párování \\ \hline
	\hline
	    Rozšiřitelnost &  & 
		Návrh tříd byl vyhodnocen jako nevhodný pro rozšiřování \\ \hline
	& &	Pokrytí testy dle nástroje cobertura - 60\% \\ \hline
	& &	Kritické chyby statické analýzy kódu - 3 \\ \hline
	& &	Minoritní chyby statické analýzy kódu - 1 \\ \hline
	\hline
	    Neefektivní chování & 4 & 
		Stránka je nově stažena v každém požadavku (i v případě chyby) \\ \hline
	& &	V případě chybného odeslání není chyba šablony nebo analyzátoru znova zpracována \\ \hline
	& &	Každá chyba analyzátoru znamená samostatný požadavek a chybu \\ \hline
	& &	Vytvoření více požadavků pokud neexistuje šablona na obchodě \\ \hline
	\hline
	    Uživatelská přívětivost & 2 & 
		Nutnost řešit chyby analyzátoru po jedná \\ \hline
	& &	Řešené chyby neobsahují bližší informace (informace o chybě, vyparsované hodnoty, použitá adresa detailu) \\ \hline
	\hline
	    Škálovatelnost & 1 & 
		Nemožnost vytvořit více instancí modulů \\ \hline
    \end{tabular}
\end{center}

...
Samotná logika plánování práce, tedy nalezení adres detailů, které chceme použít, se ukázala být nedostatečná. Chybí 
požadovaná funkcionalita. Jedná se o použití intervalu určující, kdy je požadován nový výstup a o filtrování adres pro které není
vyžadováno vytvářet a odesílat požadavek.
\par
Nový návrh tedy hledá adresy podle těchto kritérií:

\begin{itemize}
\item Adresy, které mají produkty v aktivní kampani a požadovaný interval hledání je momentálně aktuální
\item Adresy bez produktů
\item Adresy, pro které neexistuje šablona pro parsování
\item Adresy, které mají vyřešenou chybu
\end{itemize}
...
Původní návrh počítal s možností, kdy každý stránka pro detail produktu obsahuje stejnou strukturu napříč celým obchodem.
...
Tento stav nastával v případě, kdy neexistovala šablona pro detail nebo vyhledávání na obchodě, což v případě více požadavků
...
\par
Nejprve jsem upravil webové rozhraní, aby chyby týkající se stejné stránky zobrazovala v seznamu chyb pouze jednou. Po zpracování
jsem poté přidal algoritmus, který nastaví všechny chyby stejného typu jako vyřešené, čímž odpadne nutnost administrátora všechny vyřešit.

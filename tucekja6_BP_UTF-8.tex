...
připojení do databáze. Původní stav obsahoval konfigurace připojení v samostatných \textit{xml} souborech, což znamenalo, že každá nová databázová
...
Změna ulehčuje změny v databázových třídách a zpřehledňuje nastavení.

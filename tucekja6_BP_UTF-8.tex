...
\abstractEN{
This thesis describes difficulties of data mining from web with emphasis on the needs of online shops. Such need is for example trend of product prices sold by competitors. Because this issue was already addresed in team project implemented in courses BI-SP1 BI-SP2, thesis describes created system, including chosen work methods.
...
\par
Úkoly byly přidělovány jednotlivým členům týmu. Stav úkolů uchovával systém Redmine\cite{Redmine}, který umožňoval sledovat jejich stav.
...
Umožňuje automatické stažení knihoven. Standardně je nastavený jako jejich zdroj
...
Jednotlivým bodům se budu nejprve věnovat v rámci popisu nalezených konkrétních problémů. Následně budou shrnuty pomocí tabulky ze které
...
\par
Z hlediska DataProvider stačí zkontrolovat, zda požadavek uchovává staženou stránku a v kladném případě ji použít pro
parsování.
...
založené pouze na informaci obsahující jaká validace se nepovedla bez dalších informací.
...
uchovávat, aby webové rozhraní mohlo tyto informace použít.
\par
...
Vyhledáváním na obchodu je zpravidla výsledek, který obsahuje více adres detailů produktu. Na všech získaných adresách je proveden pokus o spárování, takže jsou nejdříve vyparsována příslušná data z těchto stránek. Pokud systém neuchovává všechny produkty, co existují pak část adres
...
Změněné zpracování formuláře \uv{vyřeší} i ostatní chyby stejného typu na obchodě, čímž odpadá nutnost administrátora řešit chyby postupně.
...
\par
Například na obchodě \textit{mall.cz} bylo nutné manuálně spárovat 4 ze 6 produktů. Počet nabízených všech nabízených možností ke spárování pro administrátor bylo 30. Jeden produkt se na obchodě nepodařilo nalézt a spárovat vůbec, jelikož obsahoval kompletně odlišný název oproti uloženému.
\par
...
Jednalo se například o obchod \textit{pilulka.cz}, kde se při zobrazení staženého HTML nezobrazuje EAN, takže není možné k EAN nastavit selektor. 
Obchod \textit{mall.cz} pro změnu obsah stránky překrývá upozorněním o nepodporovaném prohlížeči.
\par

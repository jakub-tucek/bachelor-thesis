...
\abstractEN{
This thesis describes general needs of online shops and realisation of team project created in courses BI-SP1 and BI-SP2 while also focusing on 
on chosen work methods.
After analysis of created system possible changes are designed. Those changes are extending existing functionality, improving expandability and fixing unwanted behaviour of created system.
Goal of this theses is implementation of most important changes and analysis based on thorough testing of modified system.
}
...
\keywordsEN{data mining, web page parsing, online shopping, Git, Jenkins, Continuous Integration, Modular Architecture}

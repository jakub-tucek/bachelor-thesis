...
\cite{exception}. Pro uchování přídavných informací bylo nutné vytvářet výjimky vlastní, tak aby byl k údajům možný pozdější přístup.
\par
...
pozměněna funkcionalita. Refaktorování se provádí za účelem dosáhnout průhlednějšího a čitelnějšího kódu, který
se lépe udržuje a rozšiřuje \cite{refaktoring}. Refaktorování kódu se především provádí při existenci konstrukcí

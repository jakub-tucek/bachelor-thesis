...
\par
V kritických částek dále chyběly částečně či kompletně testy. Jmenovitě například: databázová vrstva, vytváření požadavků pro DataProvider,
...
\section{Refactoring}
Vzhledem ke stavu kódové základní na které nebylo možné stavět, jak opravy tak možná vylepšení, rozhodl jsem se přepsat téměř celou interní část.
...
Aplikace, především v modulu ProductProvider, byla řízena pomocí chytání výjimek obsahující informace o chybě.
